...
type SalesOrder = {
  ...
  punched_by: string;
  items: { product_id: number; product_name: string; product_category: string | null; size_label: string; quantity: number; unit_price: number; additions?: { addition_id: number; addition_name: string; quantity: number; unit_price?: number }[] }[];
};
