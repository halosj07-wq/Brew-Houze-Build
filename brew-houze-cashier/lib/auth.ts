...
type SessionPayload = { adminId: number; email: string; fullName: string; role: string; canVoidOrders?: boolean; canRefundOrders?: boolean; canOpenShift?: boolean; sid?: string; exp: number };
